...
vert = loadtxt("cubeVertices.txt")
vert = 3*vert;
np = vert.shape[0]
print(vert)
print(np)
tetlist = loadtxt("cubeTetras.txt",dtype='int32') # -1 from mathematica meshes
ntet = tetlist.shape[0]
print(tetlist)
print(ntet)
			
addElastomer(vert, tetlist, 0*L/3,2*L/3,2*L/3,1,0)
